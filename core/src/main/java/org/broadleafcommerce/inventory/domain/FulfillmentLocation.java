...
public interface FulfillmentLocation extends Serializable {
	...
	/**
	 * @return a boolean value of whether or not a customer can pick up
	 *         inventory at the fulfillment location
	 */
	public Boolean getPickupLocation();

	/**
	 * Sets whether or not a customer can pick up inventory at the fulfillment
	 * location
	 * 
