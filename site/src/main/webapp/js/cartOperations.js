            ...
            BLC.ajax({url: $form.attr('action'), 
                    ...
                    if (data.error) {
                        if (data.error == 'allOptionsRequired') {
                           ...
                           HC.showNotification("这个太好了，被抢光了，下次来早点吧。");
                        }else{
                           HC.showNotification("添加到购物车失败");
                        }
                    } else {
                        ...
                        if (wishlistAdd) {
                            HC.showNotification(data.productName + "  已经添加到哦收藏夹!");
                        } else {
                            HC.showNotification(data.productName + "  已经添加到购物车!", 2000);
                        }
                    }
                }
            );
